package moonlight.file.position;
...
public class PositionManager {
	...
	public PositionManager() {
		...
		positionDir = new File(mc.mcDataDir, "moonlight/config");
	...
	public void load() {
		...
		for (String s : lines) {
			...
			if (s.toLowerCase().startsWith("pos:")) {
				Window window = Moonlight.instance.windowManager.getWindowByName(args[1]);
				if (window != null) {
