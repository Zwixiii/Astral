package moonlight.fonts.impl;

import moonlight.Moonlight;
import moonlight.fonts.api.FontFamily;
import moonlight.fonts.api.FontManager;
import moonlight.fonts.api.FontRenderer;
import moonlight.fonts.api.FontType;

public interface Fonts {

	FontManager FONT_MANAGER = Moonlight.instance.fontManager;
	...
	interface REGULAR {
		...
		final class REGULAR_35 { public static final FontRenderer REGULAR_35 = REGULAR.ofSize(31); private REGULAR_35() {} }
