package moonlight.utils.motionblur;
...
public class MotionBlurUtils {
    ...
    public float getBlurFactor() {
        return (float) Moonlight.instance.settingsManager.getSettingByName(Moonlight.instance.moduleManager.getModuleByName("MotionBlur"), "Amount").getValDouble();
    }
    ...
    public ShaderGroup getShader() {
        ...
        if (shaderBlur != getBlurFactor()) {
            ((AccessorUtils)shader).getListShaders().forEach((shader) -> {
