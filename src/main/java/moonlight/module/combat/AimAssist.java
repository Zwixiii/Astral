...
public class AimAssist extends Module{
	...
	public AimAssist() {
		...
		Moonlight.instance.settingsManager.rSetting(new Setting("ClickAim", this, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("BreakBlock", this, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("HeldItem", this, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("Horizontal", this, 4.2, 0, 6, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("Vertical", this, 2.4, 0, 6, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("Range", this, 4.2, 1.0, 8.0, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("FOV", this, 100, 20, 360, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("Strafe", this, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("Team", this, false));
	}
	...
	public void onTick(EventTick event) {
		...
		double maxAngle = Moonlight.instance.settingsManager.getSettingByName(this, "FOV").getValDouble();
		double minAngle = 0;
		
		if (Moonlight.instance.settingsManager.getSettingByName(this, "ClickAim").getValBoolean() && !mc.gameSettings.keyBindAttack.isKeyDown()) {
			return;
		}
		
		if(Moonlight.instance.settingsManager.getSettingByName(this, "BreakBlock").getValBoolean() && mc.objectMouseOver != null) {
			BlockPos blockPos = mc.objectMouseOver.getBlockPos();
            if (blockPos != null) {
                Block block = mc.theWorld.getBlockState(blockPos).getBlock();
                if (block != Blocks.air && !(block instanceof BlockLiquid) && block instanceof  Block) {
                   return;
                }
             }
		}
		
		if(Moonlight.instance.moduleManager.getModuleByName("Spin").isToggled()) {
			return;
		}
        ...
        if (!Moonlight.instance.settingsManager.getSettingByName(this, "HeldItem").getValBoolean() || mc.thePlayer.getHeldItem() != null && (mc.thePlayer.getHeldItem().getItem() instanceof ItemAxe || mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)) {
    		if (entity != null) {
    			
				double horizontalSpeed = Moonlight.instance.settingsManager.getSettingByName(this, "Horizontal").getValDouble() * 3.0 + (Moonlight.instance.settingsManager.getSettingByName(this, "Horizontal").getValDouble() > 0.0 ? this.rand.nextDouble() : 0.0);
				double verticalSpeed = Moonlight.instance.settingsManager.getSettingByName(this, "Vertical").getValDouble() * 3.0 + (Moonlight.instance.settingsManager.getSettingByName(this, "Vertical").getValDouble() > 0.0 ? this.rand.nextDouble() : 0.0);
    			...
    			if (pitchdistance <= maxAngle && yawdistance >= minAngle && yawdistance <= maxAngle) {
       				...
       				if (Moonlight.instance.settingsManager.getSettingByName(this, "Strafe").getValBoolean() && mc.thePlayer.moveStrafing != 0.0f) {
