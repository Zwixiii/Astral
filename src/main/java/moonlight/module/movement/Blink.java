...
public class Blink extends Module{
	...
	public Blink() {
		...
		Moonlight.instance.settingsManager.rSetting(new Setting("AutoDisable", this, false));
		Moonlight.instance.settingsManager.rSetting(new Setting("Delay", this, 1.5, 1, 5, false));
	}
	
	@EventTarget
	public void onTick(EventTick event) {
		if(Moonlight.instance.settingsManager.getSettingByName(this, "AutoDisable").getValBoolean()) {
			if(timer.delay(Moonlight.instance.settingsManager.getSettingByName(this, "Delay").getValDouble() * 1000)) {
