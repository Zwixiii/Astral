...
public class AutoRod extends Module{
	...
	public AutoRod() {
		...
		Moonlight.instance.settingsManager.rSetting(new Setting("Delay", this, 100, 50, 1000, false));
	}
    ...
    private void onUpdate(EventUpdate event) {
        ...
        float rodDelay = (float) Moonlight.instance.settingsManager.getSettingByName(this, "Delay").getValDouble();
