...
import moonlight.utils.InventoryUtils;
...
public class InvManager extends Module{
	...
	public InvManager() {
		...
		Moonlight.instance.settingsManager.rSetting(new Setting("Sword Slot", this, 1.0D, 1.0D, 10.0D, true));
		Moonlight.instance.settingsManager.rSetting(new Setting("Delay", this, 250.0D, 0.0D, 1000.0D, false));
	...
	public void onUpdate(EventUpdate event) {
      ...
      if ((Moonlight.instance.settingsManager.getSettingByName(this, "InvOnly").getValBoolean() && mc.currentScreen instanceof GuiInventory) || !Moonlight.instance.settingsManager.getSettingByName(this, "InvOnly").getValBoolean()) {
         ...
         if (bestSwordSlot != -1 && !this.checkDelay()) {
            mc.playerController.windowClick(windowId, bestSwordSlot < 9 ? bestSwordSlot + 36 : bestSwordSlot, (int) ((Moonlight.instance.settingsManager.getSettingByName(this, "Sword Slot").getValDouble()) - 1), 2, player);
            timer.reset();
         }
      }
   ...
   private boolean checkDelay() {
      return !timer.hasReached((long) Moonlight.instance.settingsManager.getSettingByName(this, "Delay").getValDouble());
   }
