package moonlight.clickgui.component;

import java.util.ArrayList;

import moonlight.Moonlight;
import moonlight.clickgui.component.components.Button;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : Moonlight.instance.moduleManager.getModulesInCategory(category)) {
