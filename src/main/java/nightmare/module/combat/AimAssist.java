...
public class AimAssist extends Module{
	...
	public void onTick(EventTick event) {
		...
		if (Nightmare.instance.settingsManager.getSettingByName(this, "ClickAim").getValBoolean() && !mc.gameSettings.keyBindAttack.isKeyDown()) {
			return;
		}
		
		if(Nightmare.instance.settingsManager.getSettingByName(this, "BreakBlock").getValBoolean() && mc.objectMouseOver != null) {
        ...
        if (!Nightmare.instance.settingsManager.getSettingByName(this, "HeldItem").getValBoolean() || mc.thePlayer.getHeldItem() != null && (mc.thePlayer.getHeldItem().getItem() instanceof ItemAxe || mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)) {
    		if (entity != null) {
    			...
    			if (pitchdistance <= maxAngle && yawdistance >= minAngle && yawdistance <= maxAngle) {
       				...
       				if (Nightmare.instance.settingsManager.getSettingByName(this, "Strafe").getValBoolean() && mc.thePlayer.moveStrafing != 0.0f) {
